#ifndef ATA_ANY_H_INCLUDED
#define ATA_ANY_H_INCLUDED
...
class ATA_API bad_any_cast : public std::bad_cast
{
public:
...
private: // Storage and Virtual Method Table
    ...
    struct requires_allocation :
        std::integral_constant<bool,
                !(std::is_nothrow_move_constructible<T>::value      // N4562 [Any.class]
...
namespace std
{
    inline void swap(ata::Any& lhs, ata::Any& rhs) noexcept
    {
        lhs.swap(rhs);
    }
}
