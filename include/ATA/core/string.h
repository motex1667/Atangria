...
namespace ata
{
    bool ATA_API isWhitespace(char character);
	
    bool ATA_API isWhitespace(char32_t character);

    class ATA_API String
    {
		private:
			...
			using IsStringViewType = std::enable_if_t<std::is_same_v<StringViewType, std::string_view>
				...
				|| std::is_same_v<StringViewType, std::u32string_view>, void>;
#endif
    ...
    //ATA_API std::basic_ostream<char16_t>& operator<<(std::basic_ostream<char16_t>& os, const String& str);
    //ATA_API std::basic_ostream<char32_t>& operator<<(std::basic_ostream<char32_t>& os, const String& str);
