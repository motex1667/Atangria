    ...
    if(CYGWIN)
        find_library( GLFW_glfw_LIBRARY 
            ...
            NAMES
                glfw32
            HINTS
				"${GLFW_LOCATION}/build/src"
				"${GLFW_LOCATION}/install/bin"
                "${GLFW_LOCATION}/lib"
...
if(GLFW_INCLUDE_DIR)
    ...
    if(GLFW_glfw_LIBRARY)
		...
		message(FATAL_ERROR "To build Atangria, please download GLFW +3.3 from github and specify GLFW_LOCATION or add the GLFW directory to your PATH environment variable!!")
